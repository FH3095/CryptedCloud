...
public class MainWindow extends javax.swing.JFrame {
	...
	public MainWindow() {
		...
		syncFolderListModel.addElement(new File("C:/Users/FH/Desktop/CryptedCloud/SyncFolder").getAbsolutePath());
		initComponents();
	}
	...
	private void buttonRemoveSyncedFolderActionPerformed(ActionEvent evt) {
		...
		if (selectedElement > -1 && selectedElement < syncFolderListModel.size()) {
			syncFolderListModel.remove(selectedElement);
		}
	}
	...
	private void buttonAddSyncedFolderActionPerformed(ActionEvent evt) {
		...
		syncFolderListModel.addElement(file.getAbsolutePath());
	}
